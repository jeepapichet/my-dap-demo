...
: "${SEEDFETCHER_IMAGE:=cyberark/dap-seedfetcher:latest}"
...
#  conjur_appliance_image=$(platform_image conjur-appliance)
  conjur_appliance_image=$(platform_image $CONJUR_APPLIANCE_IMAGE)
...
#  docker pull $SEEDFETCHER_IMAGE
  echo "image = $SEEDFETCHER_IMAGE"

  seedfetcher_image=$(platform_image $SEEDFETCHER_IMAGE)
